...
6. Поисковой запрос может содержать спецсимволы (!"№;%:?*()_=+) ❌
	 <img src="include/pSearch.png" sizes="(max-width: 100px)" /> <img src="include/ppSearch.png" sizes="(max-width: 100px)" />При вводе спецсимволов поиск работает некорректно
